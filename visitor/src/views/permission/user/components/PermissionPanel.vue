			...
			<div class="role-cards">
				...
				<div v-for="(role, index) in platformRoles" :key="index" class="role-card">
					<div class="role-header">
						...
						<div class="role-name">
							{{ role.name }}
							<el-tag v-if="role.isBuiltIn" class="built-in-tag" effect="plain" type="info"> 内置 </el-tag>
						</div>
					</div>
				...
				<div v-for="(app, appIndex) in subAppPermissions" :key="appIndex" class="sub-app-item">
					...
					<div class="sub-app-header">
						...
						<div class="sub-app-roles">
							<el-tag v-for="(role, roleIndex) in app.roles" :key="roleIndex" class="role-tag" type="info" effect="plain">
								{{ role }}
							</el-tag>
						</div>
					...
					<div v-if="app.permissions" class="permission-detail">
						<div class="permission-column">
							...
							<div class="permission-card">
								...
								<div class="permission-tags">
									<el-tag v-for="(perm, permIndex) in app.permissions.platformInherit" :key="permIndex" type="warning" size="small" effect="plain">
										{{ perm }}
									</el-tag>
								</div>
							</div>
						...
						<div class="permission-column">
							...
							<div class="permission-card">
								...
								<div class="permission-tags">
									<el-tag v-for="(perm, permIndex) in app.permissions.direct" :key="permIndex" type="success" size="small" effect="plain">
										{{ perm }}
									</el-tag>
								</div>
							</div>
