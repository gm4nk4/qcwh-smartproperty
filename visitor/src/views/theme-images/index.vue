...
.theme-images-page {
	...
	gap: 20px;
	background: radial-gradient(circle at top left, rgba(0, 148, 255, 0.08), transparent 32%),
		radial-gradient(circle at top right, rgba(75, 166, 169, 0.12), transparent 28%), linear-gradient(180deg, #f6f9fc 0%, #eef3f8 100%);
}
...
.theme-images-stage {
	...
	padding: 18px;
	border: 0;
	background: radial-gradient(circle at top left, rgba(0, 148, 255, 0.16), transparent 38%),
		radial-gradient(circle at bottom right, rgba(75, 166, 169, 0.15), transparent 34%), linear-gradient(180deg, #f3f8fc 0%, #edf3f8 100%);
	cursor: pointer;
	text-align: left;
	appearance: none;
}
