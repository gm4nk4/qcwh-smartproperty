...
function filterNode(value, data) {
	...
	// 同时检查label和value
	const labelMatch = data[props.objMap.label]?.toString().toLowerCase().indexOf(value.toLowerCase()) !== -1;
	const valueMatch = data[props.objMap.value]?.toString().toLowerCase().indexOf(value.toLowerCase()) !== -1;
