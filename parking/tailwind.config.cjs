	...
	theme: {
		...
		extend: {
			colors: {
				...
				text: {
					system: 'var(--theme-text-system)',
					dataAssist: 'var(--theme-text-dataAssist)',
					primaryTitle: 'var(--theme-text-primaryTitle)',
					assist: 'var(--theme-text-assist)',
				},
		...
		backgroundImage: {
			'gradient-primary': 'linear-gradient(135deg, var(--theme-gradient-start), var(--theme-gradient-end))',
			'gradient-primary-horizontal': 'linear-gradient(to right, var(--theme-gradient-start), var(--theme-gradient-end))',
			'gradient-primary-vertical': 'linear-gradient(to bottom, var(--theme-gradient-start), var(--theme-gradient-end))',
		},
		fontFamily: {
