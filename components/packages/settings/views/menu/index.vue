		...
		<div class="layout-padding-auto layout-padding-view">
			<el-row shadow="hover" v-show="showSearch" class="ml10">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
					...
					<el-form-item>
						<el-button @click="query" class="ml10" icon="search" type="primary" :loading="state.loading">
							{{ $t('common.queryBtn') }}
						</el-button>
			...
			>
				...
				<el-table-column :label="$t('common.action')" show-overflow-tooltip width="250">
					<template #default="scope">
						...
						<el-button  @click="onOpenEditMenu('edit', scope.row)" text type="primary" v-auth="'sys_menu_edit'"
							>{{ $t('common.editBtn') }}
						</el-button>
