<template>
	<div class="layout-padding-auto layout-padding-view">
		<div class="mb8">
			<el-button v-auth="'sys_dict_add'" icon="folder-add" type="primary" class="ml10" @click="dictformRef.openDialog(null, state.queryForm)">
				{{ $t('common.addBtn') }}
			</el-button>
		...
		>
			...
			<el-table-column :label="$t('common.action')" width="150">
				<template #default="scope">
					<el-button v-auth="'sys_dict_edit'" text type="primary" @click="dictformRef.openDialog(scope.row)"> {{ $t('common.editBtn') }} </el-button>
					<el-button v-auth="'sys_dict_del'" text type="primary" @click="handleDelete(scope.row)">
						{{ $t('common.delBtn') }}
					</el-button>
				</template>
			</el-table-column>
