  ...
  >
    ...
    >
      ...
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item
            command="light-blue"
            :disabled="getThemeConfig.skin === 'light-blue'"
            >淡蓝主题</el-dropdown-item
          >
          <el-dropdown-item
            command="light-green"
            :disabled="getThemeConfig.skin === 'light-green'"
            >淡绿主题</el-dropdown-item
          >
        </el-dropdown-menu>
      </template>
    </el-dropdown>
    ...
    >
      <span class="layout-navbars-breadcrumb-user-link">
        <img
          :src="userInfos.user.avatar"
          class="layout-navbars-breadcrumb-user-link-photo"
        />
...
.layout-navbars-breadcrumb-user {
  ...
  &-link {
    ...
    &-photo {
      ...
      border-radius: 100%;
      border: none;
      box-shadow: 0 0 0 1px rgba(210, 219, 233, 0.8);
    }
  }
  ...
  :deep(.layout-navbars-breadcrumb-user-icon .el-icon),
  :deep(.layout-navbars-breadcrumb-user-icon .iconfont) {
    font-size: 18px;
    line-height: 1;
  }
  ...
  :deep(.el-badge__content.is-fixed) {
    top: 5px;
    right: 7px;
    border: 2px solid var(--next-bg-main-color);
  }
