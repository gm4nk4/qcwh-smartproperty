...
const viteConfig = defineConfig((mode: ConfigEnv) => {
	...
	return {
		...
		optimizeDeps: {
			include: ['element-plus/es/locale/lang/zh-cn', 'element-plus/es/locale/lang/en', 'screenfull'],
			exclude: ['@zhqc-smart/layout', '@zhqc-smart/table', '@zhqc-smart/admin'],
		},
		server: {
			host: '0.0.0.0', // 服务器地址
