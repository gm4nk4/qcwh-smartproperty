<template>
	<div class="layout-padding parking-lot-container" :style="dashboardVars">
...
<script setup lang="ts" name="parkingLotIndex">
import { computed, ref, type Component } from 'vue';
import { useThemeConfig } from '/@/stores/themeConfig';
import { useChangeColor } from '/@/utils/theme';
import { useThemeImage } from '/@/utils/themeImages';
const ParkingInfo = defineAsyncComponent(() => import('./parkingInfo/index.vue'));
const SpaceInfo = defineAsyncComponent(() => import('./spaceInfo/index.vue'));
type MediaTabKey = 'parkingInfo' | 'spaceInfo';
const mediaTabs: Array<{ label: string; value: MediaTabKey }> = [
	{ label: '停车场信息维护', value: 'parkingInfo' },
	{ label: '车位信息维护', value: 'spaceInfo' },
];
...
const activeMediaTab = ref<MediaTabKey>('parkingInfo');
