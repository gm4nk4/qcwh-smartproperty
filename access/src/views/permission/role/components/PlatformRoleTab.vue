		...
		<div class="left-panel">
			<div class="panel-card">
				...
				<div class="search-box">
					<el-input
						v-model="platformRoleSearchText"
						placeholder="请输入平台角色名称"
						clearable
						size="small"
					>
						<template #prefix>
			...
			<div class="panel-card" v-if="currentPlatformRole">
				...
				<div class="platform-role-detail-card">
					<div class="platform-role-detail-header">
						...
						<div class="platform-role-detail-tags">
							<el-tag
								v-if="currentPlatformRole.isBuiltIn"
								type="info"
								size="small"
								class="built-in-tag"
							>内置</el-tag>
							<el-tag
								...
								effect="plain"
								class="role-code-tag"
							>{{ currentPlatformRole.roleCode }}</el-tag>
						</div>
					</div>
					...
					<div class="platform-role-detail-actions">
						...
						<el-button
							...
							:disabled="currentPlatformRole.isBuiltIn"
						>编辑</el-button>
					</div>
				</div>
				...
				<div class="app-role-allocation-container">
					<div class="app-role-allocation-grid">
						<div
							v-for="(appMap, index) in currentPlatformRole.appRoleMap"
							:key="index"
							class="app-role-card"
						...
						>
							...
							<div class="app-role-card-content">
								<div class="app-role-list">
									<div
										v-for="(role, roleIndex) in appMap.roles"
										:key="roleIndex"
										class="app-role-item"
										:class="{ selected: role.isDefault }"
									>
