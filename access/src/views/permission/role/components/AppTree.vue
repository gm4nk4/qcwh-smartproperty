		...
		<div class="tree-container">
			...
			>
				<template #default="{ node, data }">
					<div
						class="tree-node"
						:class="{ isLeaf: isLeaf(data) }"
					>
						<div class="node-content">
							<div class="node-main">
								<span
									v-if="data.type === 'group'"
									class="tree-icon group-icon"
								>
									<svg
										viewBox="0 0 24 24"
										fill="none"
									>
										<path
											d="M3 4H13V14H3V4ZM11 16H21V21H11V16ZM13 6H21V11H13V6Z"
											fill="#64748B"
										/>
									</svg>
								</span>
								...
								>
									...
									>
										<path
											d="M4 4H10V10H4V4ZM14 4H20V10H14V4ZM4 14H10V20H4V4ZM14 14H20V20H14V4Z"
											fill="#64748B"
										/>
									</svg>
								</span>
