...
export const mockAuthSubAppList: AuthSubApp[] = [
	...
	},
	{
		...
		selectedCount: 0,
		roles: [
			{ name: '社区运营', selected: false, inherited: false },
		],
	},
	{
		name: '客户评价',
	...
	},
	{
		...
		selectedCount: 0,
		roles: [
			{ name: '资产管理员', selected: false, inherited: false },
		],
	},
	{
		name: '安防监控',
		...
		selectedCount: 0,
		roles: [
			{ name: '安防管理员', selected: false, inherited: false },
		],
	},
	{
		name: '报表中心',
		...
		selectedCount: 0,
		roles: [
			{ name: '报表分析师', selected: false, inherited: false },
		],
	},
	{
		name: '能源管理',
		...
		selectedCount: 0,
		roles: [
			{ name: '能源管理员', selected: false, inherited: false },
		],
	},
];
