<template>
	...
	>
		...
		<div class="dialog-header">
			<span class="dialog-title">用户赋权</span>
		...
		<div class="main-content">
			...
			<div class="left-panel">
					...
					<div v-for="(app, appIndex) in subAppList" :key="appIndex" class="app-item">
						<div class="app-header">
							<div class="app-name">
								...
								{{ app.name }}
								<el-tag v-if="app.inherited" type="success" effect="plain" size="small">
									1个已继承
								</el-tag>
							</div>
							<div class="app-right">
								<span class="role-count" v-if="app.selectedCount > 0">
									已选 {{ app.selectedCount }} 项
								</span>
							</div>
						</div>
				...
				<div class="bottom-stat">
					<span>直接分配 <b>{{ directAssignCount }}</b> 个子应用角色</span>
					<span class="app-total">子应用覆盖：<b>{{ coveredAppCount }}</b> 个</span>
				</div>
			</div>
			...
			<div class="right-panel">
				...
				<div class="preview-section">
					...
					<div class="preview-content direct-preview">
						<el-tag
							v-for="(item, index) in directPreviewList"
							:key="index"
							type="info"
							effect="plain"
							class="preview-tag"
				...
				<div class="preview-section">
					...
					<div class="preview-content final-preview">
						<el-tag
							v-for="(item, index) in finalPreviewList"
							:key="index"
							type="success"
							effect="plain"
							class="preview-tag"
