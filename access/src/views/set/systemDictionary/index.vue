<template>
	<div class="layout-padding">
		<splitpanes>
			<pane class="ml10">
				<splitpanes >
					<pane size="30" class="treeShadowBox">
						<div class="layout-padding-auto layout-padding-view">
							<el-row>
								<div class="mb8" style="width: 100%">
									<el-button v-auth="'sys_dict_add'" @click="dicDialogRef.openDialog()" class="ml10" icon="folder-add"
										type="primary">
										{{ $t('common.addBtn') }}
									</el-button>
									<el-button :loading="loading" plain @click="handleRefreshCache()" class="ml10"
										...
										<span class="custom-tree-node">
											...
											<span class="do">
												<el-button-group>
													...
													<el-tooltip :content="$t('sysdict.deleteDisabledTip')"
														:disabled="data.systemFlag === '0'" placement="top">
														<span style="margin-left: 12px">
															<el-button :disabled="data.systemFlag !== '0'" icon="Delete"
																size="small"
							...
							<el-footer style="height: 40px; line-height: 40px">
								<el-button type="primary" size="small" icon="Download" style="width: 100%"
									@click="exportExcel">{{
										$t('common.exportBtn')
									}}</el-button>
							</el-footer>
