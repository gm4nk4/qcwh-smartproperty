<template>
	<el-row class="ml10" v-show="showSearch">
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
			<el-form-item label="操作人" prop="createBy">
				<el-input v-model="state.queryForm.createBy" placeholder="请输入操作人" clearable />
			</el-form-item>
			...
			<!-- <el-form-item label="所属模块" prop="requestUri">
				<el-input v-model="state.queryForm.requestUri" placeholder="请输入所属模块" clearable />
			</el-form-item> -->
			<el-form-item>
				<el-button @click="getDataList" icon="Search" type="primary" :loading="state.loading">{{ $t('common.queryBtn') }} </el-button>
				<el-button @click="resetQuery" icon="Refresh" :loading="state.loading">{{ $t('common.resetBtn') }}</el-button>
			</el-form-item>
		</el-form>
	</el-row>
	<el-row>
	...
	>
		...
		<el-table-column label="所属模块" prop="module" show-overflow-tooltip>
			<template #default="scope">
				<span>{{ getModule(scope.row.requestUri) }}</span>
			</template>
		</el-table-column>
